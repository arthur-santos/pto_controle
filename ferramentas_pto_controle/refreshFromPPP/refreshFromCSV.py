...
class RefreshFromCSV(QgsProcessingAlgorithm):
    """
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(
            QgsProcessingParameterFile(
                self.CSVFILE,
                self.tr('Selecionar o arquivo CSV'),
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        refresh = HandleRefreshFromCSV(folder, server_ip, port, bdname, user, password, csvfile)
        refresh.readPPP()
        return {self.OUTPUT: ''}
